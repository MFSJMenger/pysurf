...
To install pysurf, run this command in your terminal:

.. code-block:: console

    $ pip install pysurf

This is the preferred method to install pysurf, as it will always install the most recent stable release.
